# Generated by Django 4.0.4 on 2022-07-27 15:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('xlist_family', models.CharField(blank=True, editable=False, max_length=255, null=True)),
                ...
                ('primary_instructor', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='primary_sections', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='form.subject'),
        ),
        migrations.AddField(
            model_name='section',
            name='schedule_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sections', to='form.scheduletype'),
        ),
        migrations.AddField(
            model_name='section',
            name='school',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sections', to='form.school'),
        ),
        migrations.AddField(
            model_name='section',
            name='subject',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='sections', to='form.subject'),
        ),
        migrations.CreateModel(
            name='AutoAdd',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('TA', 'TaEnrollment'), ('INSTRUCTOR', 'TeacherEnrollment'), ('DESIGNER', 'DesignerEnrollment')], default=form.models.Enrollment.CanvasRole['INSTRUCTOR'], max_length=18)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('TA', 'TaEnrollment'), ('INSTRUCTOR', 'TeacherEnrollment'), ('DESIGNER', 'DesignerEnrollment')], default=form.models.Enrollment.CanvasRole['INSTRUCTOR'], max_length=18)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='form.request')),
            ],
        ),
        migrations.AddField(
            model_name='request',
            name='additional_enrollments',
            field=models.ManyToManyField(blank=True, related_name='section_enrollments', to='form.sectionenrollment'),
        ),
        migrations.AddField(
            model_name='request',
            name='included_sections',
            field=models.ManyToManyField(blank=True, related_name='requests', to='form.section'),
        ),
        migrations.AddField(
            model_name='request',
            name='proxy_requester',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='proxy_requests', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='request',
            name='requester',
        ...
        migrations.AddConstraint(
            model_name='autoadd',
            constraint=models.UniqueConstraint(fields=('school', 'subject', 'user', 'role'), name='unique_auto_add'),
        ),
        migrations.AddConstraint(
            model_name='sectionenrollment',
            constraint=models.UniqueConstraint(fields=('user', 'role', 'request'), name='unique_section_enrollment'),
        ),
    ]
